...
const auto AllocateImage = (void**(*)(const char* image, char* overlay))0x531D70;
...
const auto PlayerWillBeCaptured = (bool(*)(int playerIndex))0x509530;
...
const auto localPlayerObjectIndex = (int*)0x634370;
