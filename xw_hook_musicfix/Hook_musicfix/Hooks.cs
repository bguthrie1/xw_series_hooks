...
namespace Hook_MusicFix
{
    static class XWHooks
    {
        ...
        {
            // Change to use from winmm to win32
            // I suspect the issue is that either the memory doesn't get written to or the original memory isnt loaded fast enough
            new HookPatchItem(0xC2DA3, "57494E4D4D", "57494E3332"),
        };
        ...
        {
            new HookPatch("X-Wing 98 Music Fix", fpsPatchPtr),
        };
